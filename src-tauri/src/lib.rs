...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::system::shell_open_path,
            ...
            commands::dingtalk_stream::dingtalk_send_app_single_message,
            commands::dingtalk_stream::dingtalk_send_webhook_message,
            commands::dingtalk_stream::dingtalk_upload_media,
            commands::dingtalk_stream::dingtalk_get_download_urls,
            commands::dingtalk_stream::dingtalk_download_files,
            ...
            commands::feishu_ws::feishu_upload_image,
            commands::feishu_ws::feishu_get_image_as_base64,
            commands::feishu_ws::feishu_upload_file,
            ...
            commands::im_callback::register_im_callback_media,
            ...
            commands::database::db_search_tables,
            commands::database::db_sample_table,
